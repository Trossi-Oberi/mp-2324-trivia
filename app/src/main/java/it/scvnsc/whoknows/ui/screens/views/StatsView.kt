...
fun StatsViewPreview() {
    StatsView(navController = NavHostController(LocalContext.current), SettingsViewModel(application = LocalContext.current.applicationContext as android.app.Application))
